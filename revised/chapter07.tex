...
Zusammenfassend beantwortet die Arbeit die zentrale Forschungsfrage auf drei
aufeinander aufbauenden Ebenen. Die task-adaptive Anpassung verbessert zunächst die
Downstream-Nutzbarkeit der bereits vortrainierten URL- und HTML-Text-Repräsentationen.
Dieser Vorteil bleibt bei reduzierter gelabelter Supervision bestehen und zeigt sich ergänzend
auch auf einem unabhängig erhobenen Webseitenbestand. Im internen Suffizienzprotokoll wird
das 200k-Referenzniveau mit 50.000 Labels erreicht. Die ausgewählte Repräsentationsbasis
lässt sich anschließend in ein multimodales Vollsystem überführen, dessen Verarbeitungstiefe
über die URL-first-Kaskade instanzabhängig gesteuert werden kann.
...
Für einen betrieblichen Einsatz lassen sich die Ergebnisse entlang dreier
Entscheidungsdimensionen einordnen: verfügbare gelabelte Trainingsdaten, angestrebte
Detektionsleistung und zulässiger Inferenzaufwand.
...
erreicht. Die externe Putra-Evaluation ergänzt diesen Befund: Auch bei lediglich 200 bis
2.000 neu gelabelten Zielinstanzen erzielt RUT über die gesamte Lernkurve eine höhere AP
als R0. Eine task-adaptierte Repräsentationsbasis kann damit insbesondere dann relevant sein,
wenn für eine neue Zielumgebung zunächst nur ein begrenzter gelabelter Datenbestand
vorliegt.
...
dieses Vorgehens wurde nicht monetär bewertet. Datenerhebung, Speicherung, Aufbereitung
und zusätzlicher TAPT-Rechenaufwand bleiben neben der Annotation als eigene
Aufwandspositionen bestehen. Steht die maximale Erkennungsleistung im Vordergrund, bildet TRI Full mit 96,12\,\% TPR
bei 0,666\,\% FPR die leistungsstärkste Betriebsform des Prototyps. Die
URL-first-Kaskade ergänzt dieses System um eine bedarfsgerechte Verarbeitungstiefe.
Eindeutigere Instanzen können auf der URL-Stufe abgeschlossen werden, während unsichere
Fälle weiterhin die vollständige multimodale Verarbeitung durchlaufen.


Zur Einordnung der Größenordnung werden die gemessenen Betriebsraten linear auf
Referenzvolumina übertragen. Die ungerundete Eskalationsrate entspricht rund
14.933 vollständigen TRI-Pfaden je 100.000 Webseiten. Aus den gemessenen
In-Memory-Durchsätzen ergeben sich für 100.000 Seiten rund 9,10 Minuten für TRI Full
und 3,73 Minuten für die Kaskade. Bei unveränderten Official-Raten entsprächen die
FPR-Werte 666 gegenüber 680 Fehlalarmen je 100.000 benignen Seiten und die TPR-Werte
96.118 gegenüber 95.770 erkannten Fällen je 100.000 Phishing-Seiten.
...
erneute Kalibration erforderlich machen. Bei neu verfügbaren Webseitenbeständen kann
davon getrennt geprüft werden, ob eine erneute Repräsentationsanpassung oder eine begrenzte
Nachannotation für das Downstream-Training erforderlich ist. Kalibration,
Repräsentationsanpassung und gelabelte Nachanpassung adressieren dabei unterschiedliche
Ebenen des Systems.
...
Downstream-Trainingsmenge. Auf dem externen Putra-Bestand verbessert Quell-RUT die AP-AULC
...
eskaliert 14,93\,\% der Fälle und erreicht 95,77\,\% TPR. Im DEV-In-Memory-Benchmark sinkt
die Median-Latenz von 30,18 auf 11,95\,ms, während der Durchsatz von 183,2 auf 447,0 Seiten/s
steigt. Diese Messung umfasst nicht die vollständige betriebliche Verarbeitungskette.
